...
direct_declarator   :   IDENTIFIER                                          {strcat(buffer_identificador, $<cadena>1);}
                    |   '(' declarator ')'                                  {copiar_especial(buffer_identificador, "("); strcat(buffer_identificador, ")");}
                    |   direct_declarator '[' constant_expression_opt ']'   {strcat(buffer_identificador, "[]");}
                    |   direct_declarator '(' parameter_type_list ')'       {strcpy(buffer_identificador, "");  strcpy(buffer_identificador, ""); strcat(buffer_identificador, $<cadena>1); strcat(buffer_identificador, "()");}
                    |   direct_declarator '(' identifier_list_opt ')'       {strcpy(buffer_tipo, ""); strcpy(buffer_identificador, "");}
                    ;
